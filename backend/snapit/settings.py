"""
Django settings for snapit project.
...
SECRET_KEY = 'django-insecure-3r@%o)*^#+^s5u%led#d4c*+@aykars$!bw)e7df2)q-%9lsq='
...
WSGI_APPLICATION = 'snapit.wsgi.application'
